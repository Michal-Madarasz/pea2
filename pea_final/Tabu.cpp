...
double Tabu::ts(time_t runtime, double ** matrix1, int cities, int & solution, bool diver)
{
	...
	while (start1 < finish)
	{
		...
		//	delete[] current_route;
		//	current_route = new int[cities];
		//	int *secondPermutation = new int[cities];
		//	permutation(secondPermutation, cities);
		//	assign(current_route, secondPermutation, cities);
		//	amount = 0;
